 ...
 * Use the [CategoryServicesFragment.newInstance] factory method to
...
class CategoryServicesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CategoryServicesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CategoryServicesFragment().apply {
